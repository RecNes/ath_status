...
from all_time_high.views import one_page_view, ExchangeGraphView, BulkExchangeGraphView
...
urlpatterns = [
    ...
    path("get-all-chart-data/", BulkExchangeGraphView.as_view(), name="get-all-chart-data"),
]
